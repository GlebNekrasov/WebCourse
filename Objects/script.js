(function () {
    ...
    console.log("Страны с максимальным количеством городов:", getMaxCitiesCountCountries(countriesArray));
    console.log("страны и численность населения их городов:", getCountriesPopulation(countriesArray));
})();